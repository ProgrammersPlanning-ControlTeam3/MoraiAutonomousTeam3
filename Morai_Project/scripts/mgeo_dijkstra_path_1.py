...
class dijkstra_path_pub:
    def __init__(self):
        ...
        load_path = os.path.normpath(os.path.join(
            current_path, 'lib/mgeo_data/kcity'))
        ...
        self.node_list = ['A119BS010209', 'A119BS010313',
                          'A119BS010316', 'A119BS010324', 'A119BS010184']
        # self.node_list = ['A119BS010209', 'A119BS010313', 'A119BS010316','A119BS010324', 'A119BS010184', 'parking']
...
class Dijkstra:
    ...
    def find_shortest_link_leading_to_node(self, from_node, to_node):
        ...
        if len(to_links) == 0:
            raise BaseException(
                '[ERROR] Error @ Dijkstra.find_shortest_path : Internal data error. There is no link from node (id={}) to node (id={})'.format(self.idx, to_node.idx))
